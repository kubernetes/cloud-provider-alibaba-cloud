...
func filterOutUserManagedBackends(vBackendServers []slb.VBackendServerType, vServerGroupName string) []slb.VBackendServerType {
	var backends []slb.VBackendServerType
	for _, backend := range vBackendServers {
