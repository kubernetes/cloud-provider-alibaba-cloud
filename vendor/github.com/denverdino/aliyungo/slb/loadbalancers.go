...
type ResourceAddressType string

const (
	ResourceVPC                 = ResourceAddressType("vpc")
	ResourceInternetAddressType = ResourceAddressType("classic_internet")
	ResourceIntranetAddressType = ResourceAddressType("classic_intranet")
)
...
type DescribeAvailableResourceArgs struct {
	Action           string
	RegionId         common.Region
	AddressType      ResourceAddressType
	AddressIPVersion AddressIPVersionType
}
...
func (client *Client) DescribeAvailableResource(args *DescribeAvailableResourceArgs) (availableResources []AvailableResource, err error) {
	response := &DescribeAvailableResourceResponse{}
	err = client.Invoke("DescribeAvailableResource", args, response)
	if err != nil {
		return nil, err
	}
	return response.AvailableResources.AvailableResource, err
>>>>>>> Stashed changes
}
